...
- *(installer)* Follow latest fork release for autoupdates
...
- *(postgresql)* Add SSL algorithm configuration and management
- *(release)* Add GitHub Actions workflow for publishing release assets
