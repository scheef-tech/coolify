...
class General extends Component
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'mongoConf' => 'nullable',
            'mongoInitdbRootUsername' => ['required', 'string', 'regex:/^[a-zA-Z_][a-zA-Z0-9_]*$/'],
            'mongoInitdbRootPassword' => 'required',
            'mongoInitdbDatabase' => ['required', 'string', 'regex:/^[a-zA-Z_][a-zA-Z0-9_]*$/'],
            'image' => 'required',
    ...
    protected function messages(): array
    {
        return array_merge(
            ...
            [
                ...
                'mongoInitdbRootUsername.regex' => 'The Root Username may only contain letters, digits, and underscores, and must not start with a digit.',
                ...
                'mongoInitdbDatabase.regex' => 'The MongoDB Database may only contain letters, digits, and underscores, and must not start with a digit.',
