...
class General extends Component
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'mysqlUser' => ['required', 'string', 'regex:/^[a-zA-Z_][a-zA-Z0-9_]*$/'],
            'mysqlPassword' => 'required',
            'mysqlDatabase' => ['required', 'string', 'regex:/^[a-zA-Z_][a-zA-Z0-9_]*$/'],
            'mysqlConf' => 'nullable',
            'image' => 'required',
    ...
    protected function messages(): array
    {
        return array_merge(
            ...
            [
                ...
                'mysqlUser.regex' => 'The MySQL User may only contain letters, digits, and underscores, and must not start with a digit.',
                'mysqlPassword.required' => 'The MySQL Password field is required.',
                'mysqlDatabase.required' => 'The MySQL Database field is required.',
                'mysqlDatabase.regex' => 'The MySQL Database may only contain letters, digits, and underscores, and must not start with a digit.',
