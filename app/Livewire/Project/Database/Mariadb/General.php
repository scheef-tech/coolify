...
class General extends Component
{
    ...
    protected function rules(): array
    {
        return [
            ...
            'mariadbUser' => ['required', 'string', 'regex:/^[a-zA-Z_][a-zA-Z0-9_]*$/'],
            'mariadbPassword' => 'required',
            'mariadbDatabase' => ['required', 'string', 'regex:/^[a-zA-Z_][a-zA-Z0-9_]*$/'],
    ...
    protected function messages(): array
    {
        return array_merge(
            ...
            [
                ...
                'mariadbUser.regex' => 'The MariaDB User may only contain letters, digits, and underscores, and must not start with a digit.',
                ...
                'mariadbDatabase.regex' => 'The MariaDB Database may only contain letters, digits, and underscores, and must not start with a digit.',
