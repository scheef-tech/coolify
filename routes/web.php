...
use App\Livewire\SharedVariables\Environment\Secrets as EnvironmentSecretsShow;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::prefix('shared-variables')->group(function () {
        ...
        Route::get('/environments/project/{project_uuid}/environment/{environment_uuid}/secrets', EnvironmentSecretsShow::class)->name('shared-variables.environment.secrets');
